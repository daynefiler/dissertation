...
Illumina currently provides the \texttt{bcl2fastq} command line tool for performing all of the required tasks to produce sample-specific FASTQ files with molecular index information when applicable.
