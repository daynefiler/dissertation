...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{options}\NormalTok{(}\AttributeTok{knitr.graphics.auto\_pdf =} \ConstantTok{TRUE}\NormalTok{)}
\NormalTok{knitr}\SpecialCharTok{::}\NormalTok{opts\_chunk}\SpecialCharTok{$}\FunctionTok{set}\NormalTok{(}
  ...
  \AttributeTok{dev.args =} \FunctionTok{list}\NormalTok{(}\AttributeTok{pdf =} \FunctionTok{list}\NormalTok{(}\AttributeTok{pointsize =} \DecValTok{10}\NormalTok{),}
                  \AttributeTok{png =} \FunctionTok{list}\NormalTok{(}\AttributeTok{pointsize =} \DecValTok{10}\NormalTok{)),}
  \AttributeTok{dpi =} \DecValTok{300}
\NormalTok{)}
\NormalTok{tex  }\OtherTok{\textless{}{-}} \ConstantTok{TRUE}
\NormalTok{docx }\OtherTok{\textless{}{-}} \ConstantTok{FALSE}
\NormalTok{html }\OtherTok{\textless{}{-}} \ConstantTok{FALSE}
\ControlFlowTok{if}\NormalTok{ (}\SpecialCharTok{!}\NormalTok{knitr}\SpecialCharTok{:::}\FunctionTok{is\_latex\_output}\NormalTok{()) \{}
\NormalTok{    tex }\OtherTok{\textless{}{-}} \ConstantTok{FALSE}
    \ControlFlowTok{if}\NormalTok{ (knitr}\SpecialCharTok{:::}\FunctionTok{is\_html\_output}\NormalTok{()) \{}
\NormalTok{        html }\OtherTok{\textless{}{-}} \ConstantTok{TRUE}
\NormalTok{    \} }\ControlFlowTok{else}\NormalTok{ \{}
\NormalTok{        docx }\OtherTok{\textless{}{-}} \ConstantTok{TRUE}
\NormalTok{    \}}
\NormalTok{\}}
\FunctionTok{library}\NormalTok{(filer2020A)}
\FunctionTok{library}\NormalTok{(filer2020B)}
\FunctionTok{library}\NormalTok{(mcCNV)}
\FunctionTok{library}\NormalTok{(xtable)}
\FunctionTok{library}\NormalTok{(eulerr)}
\FunctionTok{library}\NormalTok{(dlfUtils)}
\FunctionTok{library}\NormalTok{(parallel)}
\FunctionTok{library}\NormalTok{(grid)}
\FunctionTok{library}\NormalTok{(kableExtra)}
\FunctionTok{library}\NormalTok{(MASS)}
\FunctionTok{library}\NormalTok{(tufte)}
\NormalTok{defOutWid }\OtherTok{\textless{}{-}} \ControlFlowTok{if}\NormalTok{ (html) }\StringTok{\textquotesingle{}70\%\textquotesingle{}} \ControlFlowTok{else} \ConstantTok{NULL}
\NormalTok{dblOutWid }\OtherTok{\textless{}{-}} \ControlFlowTok{if}\NormalTok{ (html) }\StringTok{\textquotesingle{}40\%\textquotesingle{}} \ControlFlowTok{else} \StringTok{\textquotesingle{}49\%\textquotesingle{}}
\FunctionTok{data}\NormalTok{(subjectMeta)}
\NormalTok{poolTbl }\OtherTok{\textless{}{-}}\NormalTok{ subjectMeta[ ,}
\NormalTok{                       .(}\AttributeTok{N =}\NormalTok{ .N,}
                         \AttributeTok{medExon =} \FunctionTok{round}\NormalTok{(}\FunctionTok{median}\NormalTok{(medIntMolCount), }\DecValTok{0}\NormalTok{),}
                         \AttributeTok{medTotal =} \FunctionTok{round}\NormalTok{(}\FunctionTok{median}\NormalTok{(totalMolCount), }\DecValTok{0}\NormalTok{),}
                         \AttributeTok{minTotal =} \FunctionTok{min}\NormalTok{(totalMolCount),}
                         \AttributeTok{maxTotal =} \FunctionTok{max}\NormalTok{(totalMolCount),}
                         \AttributeTok{rsdTotal =} \FunctionTok{sd}\NormalTok{(totalMolCount)}\SpecialCharTok{/}\FunctionTok{mean}\NormalTok{(totalMolCount)}\SpecialCharTok{*}\DecValTok{100}\NormalTok{),}
\NormalTok{                       by }\OtherTok{=}\NormalTok{ .(pool, capture, multiplexCapture)]}
\NormalTok{poolTbl[ , rsdTotal }\SpecialCharTok{:}\ErrorTok{=} \FunctionTok{round}\NormalTok{(rsdTotal, }\DecValTok{1}\NormalTok{)]}
\NormalTok{poolTbl[(}\SpecialCharTok{!}\NormalTok{multiplexCapture), pool }\SpecialCharTok{:}\ErrorTok{=} \FunctionTok{paste0}\NormalTok{(pool, }\StringTok{"$\^{}}\SpecialCharTok{\textbackslash{}\textbackslash{}}\StringTok{dagger$"}\NormalTok{)]}
\FunctionTok{kable}\NormalTok{(poolTbl[ , .(pool, capture, N, medExon, medTotal, }
\NormalTok{                   minTotal, maxTotal, rsdTotal)], }
      \AttributeTok{row.names =} \ConstantTok{FALSE}\NormalTok{, }
      \AttributeTok{label =} \StringTok{"poolSummary"}\NormalTok{,}
      ...
      \AttributeTok{caption.short =} \StringTok{"Summary of whole{-}exome sequencing for CNV project."}\NormalTok{,}
      \AttributeTok{escape =} \ConstantTok{FALSE}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{kable\_classic}\NormalTok{()}
\DocumentationTok{\#\# Create IC pools}
\NormalTok{smplSubject }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(poolName, n) \{}
  \FunctionTok{data}\NormalTok{(subjectMeta, }\AttributeTok{envir =} \FunctionTok{environment}\NormalTok{())}
\NormalTok{  subjectMeta[pool }\SpecialCharTok{==}\NormalTok{ poolName, }\FunctionTok{sample}\NormalTok{(subject, n, }\AttributeTok{replace =} \ConstantTok{FALSE}\NormalTok{)]}
\NormalTok{\}}
...
\FunctionTok{pltSubjectStatByPool}\NormalTok{(}\StringTok{"overallPhi"}\NormalTok{, }\AttributeTok{ylab =} \StringTok{"Overdispersion (phi)"}\NormalTok{)}
\FunctionTok{setkey}\NormalTok{(subjectMeta, subject)}
\FunctionTok{data}\NormalTok{(subjectCorr)}
\FunctionTok{setkey}\NormalTok{(subjectCorr, subject)}
\NormalTok{subjectCorr }\OtherTok{\textless{}{-}}\NormalTok{ subjectMeta[subjectCorr]}
\FunctionTok{data}\NormalTok{(simRes)}
\NormalTok{procSimRes }\OtherTok{\textless{}{-}} \FunctionTok{lapply}\NormalTok{(simRes, }\ControlFlowTok{function}\NormalTok{(x) }\FunctionTok{procRes}\NormalTok{(x}\SpecialCharTok{$}\NormalTok{clpRes))}

\NormalTok{simResTbl }\OtherTok{\textless{}{-}} \FunctionTok{lapply}\NormalTok{(procSimRes,}
                    \ControlFlowTok{function}\NormalTok{(x) x}\SpecialCharTok{$}\NormalTok{mnDat[ , .(mcc, tpr, fdr), }\AttributeTok{keyby =}\NormalTok{ dep])}
\NormalTok{simResTbl }\OtherTok{\textless{}{-}} \FunctionTok{Reduce}\NormalTok{(merge, simResTbl)}
\FunctionTok{setnames}\NormalTok{(simResTbl,}
         \FunctionTok{c}\NormalTok{(}\StringTok{"dep"}\NormalTok{,}
           \StringTok{"mcMCC"}\NormalTok{, }\StringTok{"mcTPR"}\NormalTok{, }\StringTok{"mcFDR"}\NormalTok{,  }\DocumentationTok{\#\# mcCNV}
           \StringTok{"edMCC"}\NormalTok{, }\StringTok{"edTPR"}\NormalTok{, }\StringTok{"edFDR"}\NormalTok{,  }\DocumentationTok{\#\# ExomeDepthDefault}
           \StringTok{"ebMCC"}\NormalTok{, }\StringTok{"ebTPR"}\NormalTok{, }\StringTok{"ebFDR"}\NormalTok{)) }\DocumentationTok{\#\# ExomeDepthBest}
\FunctionTok{setcolorder}\NormalTok{(simResTbl,}
            \FunctionTok{c}\NormalTok{(}\StringTok{"dep"}\NormalTok{, }\StringTok{"mcMCC"}\NormalTok{, }\StringTok{"edMCC"}\NormalTok{, }\StringTok{"ebMCC"}\NormalTok{, }\StringTok{"mcTPR"}\NormalTok{,}
...
\NormalTok{simResTbl }\OtherTok{\textless{}{-}}\NormalTok{ simResTbl[ , }\FunctionTok{lapply}\NormalTok{(.SD, signif, }\DecValTok{3}\NormalTok{), by }\OtherTok{=}\NormalTok{ dep]}
\FunctionTok{pltStatCompare}\NormalTok{(}\AttributeTok{xRes =}\NormalTok{ procSimRes}\SpecialCharTok{$}\NormalTok{ExomeDepthDefault, }\AttributeTok{yRes =}\NormalTok{ procSimRes}\SpecialCharTok{$}\NormalTok{mcCNV,}
               \AttributeTok{stat =} \StringTok{"mcc"}\NormalTok{, }\AttributeTok{xlab =} \StringTok{"ExomeDepth (default)"}\NormalTok{, }\AttributeTok{ylab =} \StringTok{"mcCNV"}\NormalTok{)}
\FunctionTok{addfiglab}\NormalTok{(}\StringTok{"A"}\NormalTok{)}
\FunctionTok{pltStatCompare}\NormalTok{(}\AttributeTok{xRes =}\NormalTok{ procSimRes}\SpecialCharTok{$}\NormalTok{ExomeDepthDefault, }\AttributeTok{yRes =}\NormalTok{ procSimRes}\SpecialCharTok{$}\NormalTok{mcCNV,}
               \AttributeTok{stat =} \StringTok{"tpr"}\NormalTok{, }\AttributeTok{xlab =} \StringTok{"ExomeDepth (default)"}\NormalTok{, }\AttributeTok{ylab =} \StringTok{"mcCNV"}\NormalTok{)}
\FunctionTok{addfiglab}\NormalTok{(}\StringTok{"B"}\NormalTok{)}
\FunctionTok{pltStatCompare}\NormalTok{(}\AttributeTok{xRes =}\NormalTok{ procSimRes}\SpecialCharTok{$}\NormalTok{ExomeDepthDefault, }\AttributeTok{yRes =}\NormalTok{ procSimRes}\SpecialCharTok{$}\NormalTok{mcCNV,}
               \AttributeTok{stat =} \StringTok{"fdr"}\NormalTok{, }\AttributeTok{xlab =} \StringTok{"ExomeDepth (default)"}\NormalTok{, }\AttributeTok{ylab =} \StringTok{"mcCNV"}\NormalTok{)}
\FunctionTok{addfiglab}\NormalTok{(}\StringTok{"C"}\NormalTok{)}
\FunctionTok{pltStatCompare}\NormalTok{(}\AttributeTok{xRes =}\NormalTok{ procSimRes}\SpecialCharTok{$}\NormalTok{ExomeDepthBest, }\AttributeTok{yRes =}\NormalTok{ procSimRes}\SpecialCharTok{$}\NormalTok{mcCNV,}
               \AttributeTok{stat =} \StringTok{"mcc"}\NormalTok{, }\AttributeTok{xlab =} \StringTok{"ExomeDepth (correct)"}\NormalTok{, }\AttributeTok{ylab =} \StringTok{"mcCNV"}\NormalTok{)}
\FunctionTok{addfiglab}\NormalTok{(}\StringTok{"D"}\NormalTok{)}
\FunctionTok{pltStatCompare}\NormalTok{(}\AttributeTok{xRes =}\NormalTok{ procSimRes}\SpecialCharTok{$}\NormalTok{ExomeDepthBest, }\AttributeTok{yRes =}\NormalTok{ procSimRes}\SpecialCharTok{$}\NormalTok{mcCNV,}
               \AttributeTok{stat =} \StringTok{"tpr"}\NormalTok{, }\AttributeTok{xlab =} \StringTok{"ExomeDepth (correct)"}\NormalTok{, }\AttributeTok{ylab =} \StringTok{"mcCNV"}\NormalTok{)}
\FunctionTok{addfiglab}\NormalTok{(}\StringTok{"E"}\NormalTok{)}
\FunctionTok{pltStatCompare}\NormalTok{(}\AttributeTok{xRes =}\NormalTok{ procSimRes}\SpecialCharTok{$}\NormalTok{ExomeDepthBest, }\AttributeTok{yRes =}\NormalTok{ procSimRes}\SpecialCharTok{$}\NormalTok{mcCNV,}
               \AttributeTok{stat =} \StringTok{"fdr"}\NormalTok{, }\AttributeTok{xlab =} \StringTok{"ExomeDepth (correct)"}\NormalTok{, }\AttributeTok{ylab =} \StringTok{"mcCNV"}\NormalTok{)}
\FunctionTok{addfiglab}\NormalTok{(}\StringTok{"F"}\NormalTok{)}
\FunctionTok{kable}\NormalTok{(simResTbl,}
      \AttributeTok{col.names =} \FunctionTok{c}\NormalTok{(}\StringTok{"dep"}\NormalTok{, }\FunctionTok{rep}\NormalTok{(}\FunctionTok{c}\NormalTok{(}\StringTok{"mcCNV"}\NormalTok{, }\StringTok{"ED{-}def"}\NormalTok{, }\StringTok{"ED{-}sim"}\NormalTok{), }\DecValTok{3}\NormalTok{)),}
      \AttributeTok{row.names =} \ConstantTok{FALSE}\NormalTok{, }
...
\FunctionTok{kable}\NormalTok{(wgsCallBySbj,}
      ...
      \AttributeTok{booktabs =} \ConstantTok{TRUE}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{kable\_classic}\NormalTok{() }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{add\_header\_above}\NormalTok{(}\FunctionTok{c}\NormalTok{(}\StringTok{" "} \OtherTok{=} \DecValTok{1}\NormalTok{, }\StringTok{"Total"} \OtherTok{=} \DecValTok{3}\NormalTok{, }\StringTok{"Duplications"} \OtherTok{=} \DecValTok{3}\NormalTok{, }\StringTok{"Deletions"} \OtherTok{=} \DecValTok{3}\NormalTok{))}
\NormalTok{pmLst }\OtherTok{\textless{}{-}} \FunctionTok{list}\NormalTok{()}
\NormalTok{pmLst}\SpecialCharTok{$}\NormalTok{mc }\OtherTok{\textless{}{-}} \FunctionTok{with}\NormalTok{(wgs, }\FunctionTok{evalPred}\NormalTok{(mc, wg))}
\NormalTok{pmLst}\SpecialCharTok{$}\NormalTok{ed }\OtherTok{\textless{}{-}} \FunctionTok{with}\NormalTok{(wgs, }\FunctionTok{evalPred}\NormalTok{(ed, wg))}
\NormalTok{pmLst}\SpecialCharTok{$}\NormalTok{mcSub }\OtherTok{\textless{}{-}} \FunctionTok{with}\NormalTok{(wgs[}\SpecialCharTok{!}\FunctionTok{grepl}\NormalTok{(}\StringTok{"790|851"}\NormalTok{, subject)], }\FunctionTok{evalPred}\NormalTok{(mc, wg))}
\NormalTok{pmLst}\SpecialCharTok{$}\NormalTok{edSub }\OtherTok{\textless{}{-}} \FunctionTok{with}\NormalTok{(wgs[}\SpecialCharTok{!}\FunctionTok{grepl}\NormalTok{(}\StringTok{"790|851"}\NormalTok{, subject)], }\FunctionTok{evalPred}\NormalTok{(ed, wg))}
\NormalTok{pmLst}\SpecialCharTok{$}\NormalTok{mcDup }\OtherTok{\textless{}{-}} \FunctionTok{with}\NormalTok{(wgs, }\FunctionTok{evalPred}\NormalTok{(mcDup, wgDup))}
\NormalTok{pmLst}\SpecialCharTok{$}\NormalTok{edDup }\OtherTok{\textless{}{-}} \FunctionTok{with}\NormalTok{(wgs, }\FunctionTok{evalPred}\NormalTok{(edDup, wgDup))}
\NormalTok{pmLst}\SpecialCharTok{$}\NormalTok{mcSubDup }\OtherTok{\textless{}{-}} \FunctionTok{with}\NormalTok{(wgs[}\SpecialCharTok{!}\FunctionTok{grepl}\NormalTok{(}\StringTok{"790|851"}\NormalTok{, subject)],}
                       \FunctionTok{evalPred}\NormalTok{(mcDup, wgDup))}
\NormalTok{pmLst}\SpecialCharTok{$}\NormalTok{edSubDup }\OtherTok{\textless{}{-}} \FunctionTok{with}\NormalTok{(wgs[}\SpecialCharTok{!}\FunctionTok{grepl}\NormalTok{(}\StringTok{"790|851"}\NormalTok{, subject)],}
                       \FunctionTok{evalPred}\NormalTok{(edDup, wgDup))}
\NormalTok{pmLst}\SpecialCharTok{$}\NormalTok{mcDel }\OtherTok{\textless{}{-}} \FunctionTok{with}\NormalTok{(wgs, }\FunctionTok{evalPred}\NormalTok{(mcDel, wgDel))}
\NormalTok{pmLst}\SpecialCharTok{$}\NormalTok{edDel }\OtherTok{\textless{}{-}} \FunctionTok{with}\NormalTok{(wgs, }\FunctionTok{evalPred}\NormalTok{(edDel, wgDel))}
\NormalTok{pmLst}\SpecialCharTok{$}\NormalTok{mcSubDel }\OtherTok{\textless{}{-}} \FunctionTok{with}\NormalTok{(wgs[}\SpecialCharTok{!}\FunctionTok{grepl}\NormalTok{(}\StringTok{"790|851"}\NormalTok{, subject)],}
                       \FunctionTok{evalPred}\NormalTok{(mcDel, wgDel))}
\NormalTok{pmLst}\SpecialCharTok{$}\NormalTok{edSubDel }\OtherTok{\textless{}{-}} \FunctionTok{with}\NormalTok{(wgs[}\SpecialCharTok{!}\FunctionTok{grepl}\NormalTok{(}\StringTok{"790|851"}\NormalTok{, subject)],}
                       \FunctionTok{evalPred}\NormalTok{(edDel, wgDel))}
\NormalTok{predMetrics }\OtherTok{\textless{}{-}} \FunctionTok{as.data.table}\NormalTok{(}\FunctionTok{do.call}\NormalTok{(rbind, pmLst), }\AttributeTok{keep.rownames =} \StringTok{"PredSet"}\NormalTok{)}
\NormalTok{predMetrics[ , typ }\SpecialCharTok{:}\ErrorTok{=} \FunctionTok{rep}\NormalTok{(}\FunctionTok{c}\NormalTok{(}\StringTok{"ALL"}\NormalTok{, }\StringTok{"DUP"}\NormalTok{, }\StringTok{"DEL"}\NormalTok{), }\AttributeTok{each =} \DecValTok{4}\NormalTok{)]}
\NormalTok{predMetrics[ , set }\SpecialCharTok{:}\ErrorTok{=} \FunctionTok{ifelse}\NormalTok{(}\FunctionTok{grepl}\NormalTok{(}\StringTok{"Sub"}\NormalTok{, PredSet), }\StringTok{"Sub"}\NormalTok{, }\StringTok{"Total"}\NormalTok{)]}
\NormalTok{predMetrics[ , alg }\SpecialCharTok{:}\ErrorTok{=} \FunctionTok{ifelse}\NormalTok{(}\FunctionTok{grepl}\NormalTok{(}\StringTok{"mc"}\NormalTok{, PredSet), }\StringTok{"MC"}\NormalTok{, }\StringTok{"ED"}\NormalTok{)]}
\FunctionTok{setcolorder}\NormalTok{(predMetrics, }\FunctionTok{c}\NormalTok{(}\StringTok{"typ"}\NormalTok{, }\StringTok{"set"}\NormalTok{, }\StringTok{"alg"}\NormalTok{))}
\FunctionTok{kable}\NormalTok{(predMetrics[ , .(typ, set, alg, MCC, TPR, FDR, PPV)],}
      \AttributeTok{col.names =} \FunctionTok{c}\NormalTok{(}\FunctionTok{rep}\NormalTok{(}\StringTok{""}\NormalTok{, }\DecValTok{3}\NormalTok{), }\StringTok{"MCC"}\NormalTok{, }\StringTok{"TPR"}\NormalTok{, }\StringTok{"FDR"}\NormalTok{, }\StringTok{"PPV"}\NormalTok{),}
      \AttributeTok{row.names =} \ConstantTok{FALSE}\NormalTok{, }
      \AttributeTok{label =} \StringTok{"predMet"}\NormalTok{,}
      \AttributeTok{format.args =} \FunctionTok{list}\NormalTok{(}\AttributeTok{big.mark =} \StringTok{","}\NormalTok{, }\AttributeTok{scientific =} \ConstantTok{FALSE}\NormalTok{),}
      \AttributeTok{booktabs =} \ConstantTok{TRUE}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{kable\_classic}\NormalTok{() }\SpecialCharTok{\%\textgreater{}\%}
...
\NormalTok{ctsAll }\OtherTok{\textless{}{-}} \FunctionTok{euler}\NormalTok{(wgs[ , .(mc, ed, wg)])}
\NormalTok{ctsSub }\OtherTok{\textless{}{-}} \FunctionTok{euler}\NormalTok{(wgs[}\SpecialCharTok{!}\FunctionTok{grepl}\NormalTok{(}\StringTok{"790|851"}\NormalTok{, subject), .(mc, ed, wg)])}
...
\FunctionTok{setkey}\NormalTok{(smry, smp)}
\DocumentationTok{\#\# Allele depth histograms}
\CommentTok{\# par(oma = c(3, 0, 0, 0), mfrow = c(3, 1))}
\FunctionTok{layout}\NormalTok{(}\FunctionTok{matrix}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\DecValTok{4}\NormalTok{, }\AttributeTok{ncol =} \DecValTok{1}\NormalTok{), }\AttributeTok{heights =} \FunctionTok{c}\NormalTok{(}\FunctionTok{rep}\NormalTok{(}\DecValTok{10}\NormalTok{, }\DecValTok{3}\NormalTok{), }\DecValTok{1}\NormalTok{))}
\FunctionTok{with}\NormalTok{(gt[use }\SpecialCharTok{\&}\NormalTok{ smp }\SpecialCharTok{==} \StringTok{"S1"}\NormalTok{], }\FunctionTok{cfPltFreqHist}\NormalTok{(alt, udep, gtCall, }\AttributeTok{ff =}\NormalTok{ ff[}\DecValTok{1}\NormalTok{]))}
\FunctionTok{title}\NormalTok{(}\AttributeTok{ylab =} \StringTok{"Case 1"}\NormalTok{, }\AttributeTok{line =} \DecValTok{1}\NormalTok{)}
\FunctionTok{addfiglab}\NormalTok{(}\StringTok{"A"}\NormalTok{)}

\FunctionTok{data}\NormalTok{(rs140468248)}
\FunctionTok{data}\NormalTok{(GenoMeta)}
\FunctionTok{with}\NormalTok{(gt[use }\SpecialCharTok{\&}\NormalTok{ smp }\SpecialCharTok{==} \StringTok{"S2"}\NormalTok{], }\FunctionTok{cfPltFreqHist}\NormalTok{(alt, udep, gtCall, }\AttributeTok{ff =}\NormalTok{ ff[}\DecValTok{1}\NormalTok{]))}
\NormalTok{oiCall }\OtherTok{\textless{}{-}}\NormalTok{ gt[varid }\SpecialCharTok{==}\NormalTok{ rs140468248, gtCall]}
\NormalTok{oiPmar }\OtherTok{\textless{}{-}}\NormalTok{ gt[varid }\SpecialCharTok{==}\NormalTok{ rs140468248, alt}\SpecialCharTok{/}\NormalTok{(ref }\SpecialCharTok{+}\NormalTok{ alt)]}
\FunctionTok{abline}\NormalTok{(}\AttributeTok{v =}\NormalTok{ oiPmar, }\AttributeTok{col =}\NormalTok{ GenoMeta}\SpecialCharTok{$}\NormalTok{color[GenoMeta}\SpecialCharTok{$}\NormalTok{name }\SpecialCharTok{==}\NormalTok{ oiCall])}
\FunctionTok{text}\NormalTok{(}\AttributeTok{x =}\NormalTok{ oiPmar,}
     \AttributeTok{y =} \FunctionTok{grconvertY}\NormalTok{(}\FloatTok{0.75}\NormalTok{, }\StringTok{"nfc"}\NormalTok{),}
     \StringTok{"rs140468248"}\NormalTok{,}
     \AttributeTok{srt =} \DecValTok{90}\NormalTok{,}
     \AttributeTok{adj =} \FunctionTok{c}\NormalTok{(}\FloatTok{0.5}\NormalTok{, }\FloatTok{1.5}\NormalTok{),}
     \AttributeTok{col =}\NormalTok{ GenoMeta}\SpecialCharTok{$}\NormalTok{color[GenoMeta}\SpecialCharTok{$}\NormalTok{name }\SpecialCharTok{==}\NormalTok{ oiCall])}
\FunctionTok{title}\NormalTok{(}\AttributeTok{ylab =} \StringTok{"Case 2"}\NormalTok{, }\AttributeTok{line =} \DecValTok{1}\NormalTok{)}
\FunctionTok{addfiglab}\NormalTok{(}\StringTok{"B"}\NormalTok{, }\AttributeTok{units =} \StringTok{\textquotesingle{}nfc\textquotesingle{}}\NormalTok{)}

\FunctionTok{with}\NormalTok{(gt[use }\SpecialCharTok{\&}\NormalTok{ smp }\SpecialCharTok{==} \StringTok{"FES{-}0034{-}4"}\NormalTok{], }\FunctionTok{cfPltFreqHist}\NormalTok{(alt, udep, gtCall, }\AttributeTok{ff =}\NormalTok{ ff[}\DecValTok{1}\NormalTok{]))}
\FunctionTok{title}\NormalTok{(}\AttributeTok{ylab =} \StringTok{"Case 3"}\NormalTok{, }\AttributeTok{line =} \DecValTok{1}\NormalTok{)}
\FunctionTok{addfiglab}\NormalTok{(}\StringTok{"C"}\NormalTok{, }\AttributeTok{units =} \StringTok{\textquotesingle{}nfc\textquotesingle{}}\NormalTok{)}

\FunctionTok{par}\NormalTok{(}\AttributeTok{mar =} \FunctionTok{rep}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{4}\NormalTok{))}
\FunctionTok{plot.new}\NormalTok{()}
\FunctionTok{legend}\NormalTok{(}\AttributeTok{x =} \FunctionTok{grconvertX}\NormalTok{(}\FloatTok{0.5}\NormalTok{, }\AttributeTok{from =} \StringTok{"nfc"}\NormalTok{),}
       \AttributeTok{y =} \FunctionTok{grconvertY}\NormalTok{(}\FloatTok{0.5}\NormalTok{, }\AttributeTok{from =} \StringTok{"nfc"}\NormalTok{),}
       \AttributeTok{legend =}\NormalTok{ GenoMeta}\SpecialCharTok{$}\NormalTok{name,}
       \AttributeTok{horiz =} \ConstantTok{TRUE}\NormalTok{,}
       \AttributeTok{lwd =} \DecValTok{4}\NormalTok{,}
       \AttributeTok{col =}\NormalTok{ GenoMeta}\SpecialCharTok{$}\NormalTok{color,}
...
\DocumentationTok{\#\# Collect read depth and filtering information into a table}
\FunctionTok{data}\NormalTok{(readSmry)}
\NormalTok{rs }\OtherTok{\textless{}{-}}\NormalTok{ readSmry}\SpecialCharTok{$}\NormalTok{summary}
\NormalTok{rs[ , pctDup }\SpecialCharTok{:}\ErrorTok{=} \FunctionTok{round}\NormalTok{(pctDup, }\DecValTok{2}\NormalTok{)]}
\NormalTok{rs[ , pctFlt }\SpecialCharTok{:}\ErrorTok{=} \FunctionTok{round}\NormalTok{(pctFlt, }\DecValTok{2}\NormalTok{)]}
\FunctionTok{setkey}\NormalTok{(rs, smp)}
\NormalTok{rs }\OtherTok{\textless{}{-}}\NormalTok{ smry[rs]}
\NormalTok{rs[ , ff }\SpecialCharTok{:}\ErrorTok{=} \FunctionTok{round}\NormalTok{(ff, }\DecValTok{3}\NormalTok{)]}
\NormalTok{rs[smp }\SpecialCharTok{==} \StringTok{"S1"}\NormalTok{, case }\SpecialCharTok{:}\ErrorTok{=} \StringTok{"Case 1"}\NormalTok{]}
\NormalTok{rs[smp }\SpecialCharTok{==} \StringTok{"S2"}\NormalTok{, case }\SpecialCharTok{:}\ErrorTok{=} \StringTok{"Case 2"}\NormalTok{]}
\NormalTok{rs[}\FunctionTok{grepl}\NormalTok{(}\StringTok{"FES"}\NormalTok{, smp), case }\SpecialCharTok{:}\ErrorTok{=} \StringTok{"Case 3"}\NormalTok{]}
...
\DocumentationTok{\#\# Generate plots}
\FunctionTok{par}\NormalTok{(}\AttributeTok{mfrow =} \FunctionTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{, }\DecValTok{2}\NormalTok{), }\AttributeTok{oma =} \FunctionTok{c}\NormalTok{(}\DecValTok{3}\NormalTok{, }\DecValTok{0}\NormalTok{, }\DecValTok{0}\NormalTok{, }\DecValTok{0}\NormalTok{))}
\FunctionTok{par}\NormalTok{(}\AttributeTok{mar =} \FunctionTok{c}\NormalTok{(}\DecValTok{4}\NormalTok{, }\DecValTok{4}\NormalTok{, }\DecValTok{1}\NormalTok{, }\DecValTok{1}\NormalTok{))}
\FunctionTok{plot.new}\NormalTok{()}
\FunctionTok{plot.window}\NormalTok{(}\AttributeTok{xlim =} \FunctionTok{range}\NormalTok{(}\FunctionTok{c}\NormalTok{(matDen}\SpecialCharTok{$}\NormalTok{x, fetDen}\SpecialCharTok{$}\NormalTok{x)), }\FunctionTok{range}\NormalTok{(}\FunctionTok{c}\NormalTok{(matDen}\SpecialCharTok{$}\NormalTok{y, fetDen}\SpecialCharTok{$}\NormalTok{y)))}
\FunctionTok{lines}\NormalTok{(matDen, }\AttributeTok{col =} \StringTok{"darkblue"}\NormalTok{, }\AttributeTok{lwd =} \DecValTok{2}\NormalTok{)}
\FunctionTok{lines}\NormalTok{(fetDen, }\AttributeTok{col =} \StringTok{"darkorange"}\NormalTok{, }\AttributeTok{lwd =}\DecValTok{2}\NormalTok{)}
\FunctionTok{axis}\NormalTok{(}\AttributeTok{side =} \DecValTok{1}\NormalTok{)}
\FunctionTok{title}\NormalTok{(}\AttributeTok{xlab =} \StringTok{"Fragment length (insert size)"}\NormalTok{, }\AttributeTok{ylab =} \StringTok{"Density"}\NormalTok{)}
\FunctionTok{addfiglab}\NormalTok{(}\StringTok{"A"}\NormalTok{)}
\FunctionTok{plot.new}\NormalTok{()}
\NormalTok{xv }\OtherTok{\textless{}{-}} \FunctionTok{seq}\NormalTok{(}\DecValTok{50}\NormalTok{, }\DecValTok{300}\NormalTok{, }\DecValTok{1}\NormalTok{)}
\FunctionTok{plot.window}\NormalTok{(}\AttributeTok{xlim =} \FunctionTok{range}\NormalTok{(xv), }\AttributeTok{ylim =} \DecValTok{0}\SpecialCharTok{:}\DecValTok{1}\NormalTok{)}
\FunctionTok{points}\NormalTok{(}\AttributeTok{x =}\NormalTok{ xv, }\AttributeTok{y =} \FunctionTok{matCdf}\NormalTok{(xv), }\AttributeTok{col =} \StringTok{"darkblue"}\NormalTok{, }\AttributeTok{lwd =} \DecValTok{2}\NormalTok{, }\AttributeTok{type =} \StringTok{"l"}\NormalTok{)}
\FunctionTok{points}\NormalTok{(}\AttributeTok{x =}\NormalTok{ xv, }\AttributeTok{y =} \FunctionTok{fetCdf}\NormalTok{(xv), }\AttributeTok{col =} \StringTok{"darkorange"}\NormalTok{, }\AttributeTok{lwd =} \DecValTok{2}\NormalTok{, }\AttributeTok{type =} \StringTok{"l"}\NormalTok{)}
\FunctionTok{addfiglab}\NormalTok{(}\StringTok{"B"}\NormalTok{, }\AttributeTok{units =} \StringTok{\textquotesingle{}nfc\textquotesingle{}}\NormalTok{)}
\FunctionTok{axis}\NormalTok{(}\AttributeTok{side =} \DecValTok{1}\NormalTok{)}
